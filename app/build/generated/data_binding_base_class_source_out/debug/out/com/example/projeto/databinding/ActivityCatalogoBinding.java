...
public final class ActivityCatalogoBinding implements ViewBinding {
  ...
  private ActivityCatalogoBinding(@NonNull RelativeLayout rootView,
      @NonNull NotificationBadge badge, @NonNull ImageView cartButton,
  ...
  public static ActivityCatalogoBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityCatalogoBinding((RelativeLayout) rootView, badge, cartButton, imageButton,
          imageButton2, imageButton3, imageButton4, imageButton5, mainScroll, textView28, textView3,
