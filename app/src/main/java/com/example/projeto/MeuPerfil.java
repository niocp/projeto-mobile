    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                fAuth.signInWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if(task.isSuccessful()) {
                            ...
                            Toast.makeText(MeuPerfil.this, "Logado com sucesso!", Toast.LENGTH_SHORT).show();
                            startActivity(new Intent(getApplicationContext(), MainActivity.class));

                        } else {

                            Toast.makeText(MeuPerfil.this, "Erro ! " + task.getException().getMessage(),Toast.LENGTH_SHORT).show();
        ...
        mCreateBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(getApplicationContext(), TelaDeCadastro.class));
